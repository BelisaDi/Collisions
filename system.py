    ...
    def main_loop_2(self):
        ...
        while(val):
            ...
            if self.time_sim >= self.TIME_MAX:
                val = False
            print("////////////////////////////////////////////////////////////")
            print("MIN BINARY HEAP: ")
            for evento in self.minpq:
                print(evento)
            print("TIEMPO DE LA SIMULACIÓN: " + str(self.time_sim) + "\n")
            print("////////////////////////////////////////////////////////////")
            evn = heapq.heappop(self.minpq)
            print("Vamos a chequear este evento: ")
            print(evn)
            if evn.disk_a != None and evn.disk_b != None:
                print("El evento tiene las siguientes colisiones totales: ")
                print(evn.TOTAL_COLLS)
                print("Y los discos tienen las siguientes colisiones totales: ")
                print(evn.disk_a.disk_colls + evn.disk_a.wall_colls + evn.disk_b.disk_colls + evn.disk_b.wall_colls)
                ...
                print(evn.TOTAL_COLLS)
                print("Y los discos tienen las siguientes colisiones totales: ")
                print(evn.disk_b.disk_colls + evn.disk_b.wall_colls)
                ...
                print(evn.TOTAL_COLLS)
                print("Y los discos tienen las siguientes colisiones totales: ")
                print(evn.disk_a.disk_colls + evn.disk_a.wall_colls)
